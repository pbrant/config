...
autocmd FileType purescript nnoremap <F6> :CocCommand purescript.restartPscIde<CR>
autocmd FileType purescript nnoremap <F7> :CocCommand purescript.build<CR>
...
let g:markdown_fenced_languages = ['purescript', 'python', 'bash=sh']

nnoremap ,cc :! ctags -R --exclude=target --exclude=node_modules<CR><CR>

digr ee 8799

autocmd BufWritePre *.purs Neoformat purty
if filereadable("./.scalafmt.conf")
  autocmd BufWritePre *.{sbt,scala} Format
endif
